...
export default function(props){
  ...
  <form action="#">
    <div className="mdl-textfield mdl-js-textfield">
      <input className="mdl-textfield__input" maxLength="200" type="text" id="sample1" value={props.post.title} onChange={(e)=>props.onPostChange("title",e.target.value)}/>
      <label className="mdl-textfield__label" htmlFor="sample1"  style={{display:(props.post.title.length>0?"none":"auto")}}>Title...</label>
    </div>
    <br/>
    <div className="mdl-textfield mdl-js-textfield">
      <textarea className="mdl-textfield__input" maxLength="5000" type="text" rows= "3" id="sample5" value={props.post.content} onChange={(e)=>props.onPostChange("content",e.target.value)}></textarea>
